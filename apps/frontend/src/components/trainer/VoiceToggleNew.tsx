// apps/frontend/src/components/trainer/VoiceToggleNew.tsx
...
const VoiceToggle: React.FC<VoiceToggleProps> = ({ isEnabled, onToggle }) => {
  ...
  // Memoize ARIA attributes to ensure they're static strings
  const ariaAttributes = useMemo(() => ({
    ...
    'aria-pressed': isEnabled ? 'true' as const : 'false' as const
  }), [isEnabled]);
